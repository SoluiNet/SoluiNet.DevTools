...
namespace SoluiNet.DevTools.Core.Windows.Tools.Database
{
    ...
    public class DbHelper : Core.Tools.Database.DbHelper
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA1801:Review unused parameter", Justification = "'impersonation' parameter has been added for future implementations")]
